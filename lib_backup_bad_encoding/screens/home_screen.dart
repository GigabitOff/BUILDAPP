...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> loadUser() async {
    ...
    setState(() {
      userName = prefs.getString('user_name') ?? 'РџРѕР»СЊР·РѕРІР°С‚РµР»СЊ';
        ...
        child: ListView(
          ...
          children: [
            ...
            buildCard(
              ...
              title: 'РџСЂРѕРІРµСЂРёС‚СЊ Р°РІС‚РѕСЂРёР·Р°С†РёСЋ',
              subtitle: 'РџСЂРѕРІРµСЂРєР° С‚РѕРєРµРЅР° С‡РµСЂРµР· /api/me',
            ...
            buildCard(
              ...
              subtitle: unreadNotificationsCount > 0
                  ? 'РќРµРїСЂРѕС‡РёС‚Р°РЅРЅС‹С…: $unreadNotificationsCount'
                  : 'РР·РјРµРЅРµРЅРёСЏ РїРѕ РѕР±СЉРµРєС‚Р°Рј',
            ...
            if (isAdmin) ...[
              ...
              buildCard(
                ...
                subtitle: 'Р’СЃРµРіРѕ РїРѕР»СЊР·РѕРІР°С‚РµР»РµР№: $usersCount',
            ...
            buildCard(
              ...
              title: 'РћР±СЉРµРєС‚С‹ СЃС‚СЂРѕРёС‚РµР»СЊСЃС‚РІР°',
              subtitle: 'Р’СЃРµРіРѕ РѕР±СЉРµРєС‚РѕРІ: $objectsCount',
            ...
            buildCard(
              ...
              title: 'Р—Р°РґР°С‡Рё',
              subtitle: 'Р’СЃРµРіРѕ Р·Р°РґР°С‡: $tasksCount',
            ...
            buildCard(
              ...
              title: 'Р¤РѕС‚РѕРѕС‚С‡С‘С‚С‹',
              subtitle: 'Р’СЃРµРіРѕ С„РѕС‚РѕРѕС‚С‡С‘С‚РѕРІ: $photoReportsCount',
