    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          ...
          SizedBox(height: 8),
          Text(
            'Создай первый аккаунт администратора. После этого можно добавлять пользователей, объекты и задачи.',
    ...
    return Container(
      ...
      child: const Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'Этот пользователь станет администратором новой компании.',
              style: TextStyle(
